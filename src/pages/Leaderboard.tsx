                                    ...
                                    leaderboard.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="flex items-center">
                                                    <div 
                                                        className="flex-shrink-0 h-10 w-10 rounded-full bg-soviet-red-100 flex items-center justify-center text-soviet-red-700 font-bold border-2 border-white shadow-sm overflow-hidden cursor-pointer hover:ring-2 hover:ring-soviet-red-300 transition-all"
                                                    ...
                                                    <div className="ml-4">
                                                        <div className="text-sm font-medium text-gray-900 font-serif hover:text-soviet-red-700 cursor-pointer" onClick={() => navigate(`/profile/${item.user_id}`)}>
                                                            {item.name}
                                                        </div>
